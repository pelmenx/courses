...
def valid_release_date(d, n):
    day = d.weekday()
    # print (day, n)
    if n == "Album" and day == 0:
        return True
    elif n == "Game" and day == 1:
        return True
    elif n == "Show" and day == 2:
        return True
    elif n == "Show" and day == 6:
        return True
    elif n == 'Movie' and day == 4:
        return True
    elif n == 'Play' and day == 5:
        return True
    else:
        return False
