...
def check_availability(Meetings_list, now_time):
    for items in Meetings_list:
        if now_time > items.start_time and now_time < items.end_time:
            return False
    return True
...
meetings = [Meeting(datetime(2018, 8, 1, 9, 0, 0), datetime(2018, 8, 1, 11, 0, 0)),
            Meeting(datetime(2018, 8, 1, 15, 0, 0),
                    datetime(2018, 8, 1, 16, 0, 0)),
