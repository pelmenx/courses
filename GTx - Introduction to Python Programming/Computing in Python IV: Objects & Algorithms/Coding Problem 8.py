...
def rabbit_hole(holes_dictionary, start_position):
    try:
        return rabbit_hole(holes_dictionary, holes_dictionary[start_position])
    except RecursionError:
        return False
    except KeyError:
        # print(d[start_position])
        try:
            return holes_dictionary[start_position]
        except KeyError:
